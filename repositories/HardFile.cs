...
namespace DocumentationBenchmark.Pipeline
{
    ...
    public class EventPipeline<TEvent> where TEvent : class, ICloneable, new()
    {
        ...
        /// <param name="handler">The action to execute when an event is processed.</param>
        ...
        /// </summary>
        /// <typeparam name="TTransformed">The type of the transformed output event.</typeparam>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="events"/> is null or empty.</exception>
