...
namespace DocumentationBenchmark.Pipeline
{
    ...
    public interface IEventTransformer<TInput, TOutput> where TOutput : class, new()
    {
        ...
        /// <returns>A task that represents the asynchronous operation, containing the transformed output event.</returns>
    ...
    /// </summary>
    /// <typeparam name="TEvent">The type of events to be processed.</typeparam>
    public class EventPipeline<TEvent> where TEvent : class, ICloneable, new()
    {
        ...
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous operation, containing the result of the processing.</returns>
    ...
    /// <summary>
    /// Represents statistics about the event processing.
    /// </summary>
