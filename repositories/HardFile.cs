...
{
    /// <summary>
    /// Defines a contract for transforming events from one type to another.
    /// </summary>
    ...
    public interface IEventTransformer<TInput, TOutput> where TOutput : class, new()
    {
        ...
        /// <returns>A task that represents the asynchronous operation, with the transformed output event as the result.</returns>
    ...
    /// <summary>
    /// Represents a pipeline for processing events.
    /// </summary>
    /// <typeparam name="TEvent">The type of events that the pipeline processes.</typeparam>
    public class EventPipeline<TEvent> where TEvent : class, ICloneable, new()
    {
        ...
        /// </summary>
        /// <typeparam name="TTransformed">The type of the transformed events.</typeparam>
        ...
        /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
        /// <returns>A task that represents the asynchronous operation, with the result of the processing.</returns>
        ...
        /// <summary>
        /// Gets the statistics of the event processing pipeline.
        /// </summary>
