...
{
    /// <summary>
    /// Provides methods for sanitizing strings, including normalizing whitespace and generating slugs.
    /// </summary>
    public static class StringSanitizer
    {
        /// <summary>
        /// Normalizes whitespace in the input string by replacing consecutive whitespace characters with a single space.
        /// </summary>
        ...
        /// </summary>
        /// <param name="phrase">The input phrase to convert into a slug.</param>
        /// <param name="maxLength">The maximum length of the slug. Default is 50.</param>
        /// <returns>A URL-friendly slug derived from the input phrase.</returns>
    ...
    /// <summary>
    /// Exception thrown when a sanitization error occurs.
    /// </summary>
